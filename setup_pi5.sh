...
echo "  • Log Directory:       ✓ /var/log/recorder/"
...
echo ""
echo "   Use this mode to test that everything works."
echo "   Press Ctrl+C to stop."
echo ""
echo "🚀 Production Mode (Auto-Start & Auto-Recovery):"
echo "   After testing manually, install systemd services:"
echo ""
echo "   ./systemd/install.sh"
echo ""
echo "   This enables:"
